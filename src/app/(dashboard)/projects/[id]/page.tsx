  ...
  const PHASE_PIC_CONFIG = {
    phase1: {
      ...
      roles: [
        ...
        { role: "keuangan", label: "Corporate Finance", multi: true },
        { role: "hukum", label: "Legal & Regulatory Affairs", multi: true },
        { role: "risiko", label: "Risk Management", multi: true },
        { role: "ketua_tim", label: "Ketua Tim", multi: true },
      ],
    },
    phase2: {
      label: "Fase 2",
