...
const FIELD_LABELS: Record<string, string> = {
  ...
  ceoName: "Direktur Utama (CEO)",
  cooName: "Direktur Operasi (COO)",
  cfoName: "Direktur Keuangan (CFO)",
  otherDirectors: "Direksi Lainnya",
  shareholderComposition: "Komposisi Pemegang Saham",
...
const SECTIONS: { key: string; title: string; fields: string[] }[] = [
  {
    ...
    fields: [
      ...
      "ceoName", "cooName", "cfoName", "otherDirectors",
...
const VALUE_LABELS: Record<string, string> = {
  ...
  minority: "Pemegang Saham Minoritas (45% - 49%)",
  yes: "Ya",
  no: "Tidak",
};
    ...
    <div className={cn("space-y-4", className)}>
      ...
      {formData.noExperience && (
        <div className="rounded-xl border border-gray-200 overflow-hidden">
          ...
          <div className="p-4"><p className="text-xs text-amber-700 bg-amber-50 rounded-lg px-3 py-2">Ditandai tidak memiliki pengalaman</p></div>
        </div>
      )}
