            ...
            {(location || capacityMw || indicativeCapex || npv || der || lifetime) && (
              <div className="rounded-lg border border-ptba-light-gray overflow-hidden">
                ...
                <div className="divide-y divide-ptba-light-gray/50 px-4">
                  ...
                  {indicativeCapex && <div className="flex justify-between py-2.5"><span className="text-sm text-ptba-gray">Indicative Capex</span><span className="text-sm font-medium text-ptba-charcoal">$ {indicativeCapex} Mn</span></div>}
                  {npv && <div className="flex justify-between py-2.5"><span className="text-sm text-ptba-gray">Net Present Value (NPV)</span><span className="text-sm font-medium text-ptba-charcoal">$ {npv} Mn</span></div>}
