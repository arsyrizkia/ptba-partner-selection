...
export const PROJECT_STEPS: ProjectStep[] = [
  ...
  { step: 4, name: 'Evaluasi Fase 1', description: 'Evaluasi EBD terhadap dokumen EoI mitra (sistem gugur)', phase: 'phase1' },
  ...
  { step: 7, name: 'Pengumuman Shortlist', description: 'Pengumuman mitra yang lolos ke Fase 2', phase: 'phase1' },
  // Fase 2: Detailed Assessment (Sistem Gugur - 6 evaluators: 3 EBD + Legal, Finance, Risk)
  { step: 8, name: 'Pendaftaran Fase 2', description: 'Registrasi dan pembayaran biaya pendaftaran Fase 2', phase: 'phase2' },
