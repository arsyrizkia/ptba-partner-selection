...
export const PROJECT_STEPS: ProjectStep[] = [
  ...
  { step: 4, name: 'Evaluasi Tahap 1', description: 'Evaluasi 6 aspek terhadap dokumen dan data mitra', phase: 'phase1' },
  ...
  { step: 9, name: 'Evaluasi Tahap 2', description: 'Evaluasi 6 aspek terhadap proposal dan penawaran', phase: 'phase2' },
